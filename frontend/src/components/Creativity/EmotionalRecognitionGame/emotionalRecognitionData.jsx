...
export const MATCH_EMOTION_ROUNDS = [
  {
    ...
    pairs: [
      { id: 'happy', name: 'Happy', emoji: '😊', color: '#eab308' },
      { id: 'sad', name: 'Sad', emoji: '😢', color: '#0284c7' },
  ...
  },
  {
    ...
    pairs: [
      { id: 'scared', name: 'Scared', emoji: '😨', color: '#6366f1' },
      { id: 'surprised', name: 'Surprised', emoji: '😲', color: '#ec4899' },
      { id: 'excited', name: 'Excited', emoji: '🤩', color: '#f59e0b' },
      { id: 'calm', name: 'Calm', emoji: '😌', color: '#10b981' }
    ]
  }
];
